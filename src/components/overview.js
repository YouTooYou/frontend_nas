...
class Overview extends Component {
    ...
    async updateCache() {
        ...
        // Accepts JSON: {accheName: 'CacheOne', cacheData: '1 CacheData', url: 'https://192.168.1.4:3000'}
        for (let i = 0; i < this.state.items.length; i++) {
            ...
            if ('caches' in window) {
                ...
                await cache.put("http://192.168.1.4:3000", data);
            }
        }
        ...
        // console.log(caches.open("http://192.168.1.4:3000"))
    }
